...
var accessDB = function(appVersion, outputDir, dest, htmlPath, newhtmlPATH) {
  var mongoURL = 'mongodb://localhost:27017/apksDB'; //to be changed

  MongoClient.connect(mongoURL, function(err, db) {
    assert.equal(null, err);
    console.log("Connected correctly to server");

    var collection = db.collection("apks"); //to be changed
