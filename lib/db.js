              ...
              moveAPK(dest, appVersion, movesem, function() {
                moveHTML(htmlPath, dirpluginPATH, appVersion, movesem, db, function() {
                  moveComment(tempCommentPath, dirpluginPATH, appVersion, movesem, function() {
                    runScraper(dirpluginPATH, appVersion, function() {
                      movesem.leave();
...
var makeDir = function(appVersion) {
...
var moveAPK = function(dest, appVersion, movesem) {
...
var moveHTML = function(htmlPath, dirpluginPATH, appVersion, movesem, db) {
...
var moveComment = function(tempCommentPath, dirpluginPATH, appVersion, movesem) {
...
var delAll = function(appVersion, tempCommentPath, htmlPath, dest, db) {
...
var runScraper = function(path, appVersion, callback) {
  var scraper = config.get('scraper'),
      COMMAND = scraper + " " + appVersion.ID + " -o " + path;
